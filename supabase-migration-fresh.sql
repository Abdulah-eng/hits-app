-- ==============================================================================
-- H.I.T.S. Database Fresh Migration Script
-- This script drops ALL existing tables, policies, triggers, and functions
-- then creates everything from scratch. USE WITH CAUTION!
-- ==============================================================================
...
DROP FUNCTION IF EXISTS is_specialist(UUID) CASCADE;
DROP FUNCTION IF EXISTS is_client(UUID) CASCADE;
...
BEGIN
  ...
  RAISE NOTICE 'All tables, triggers, functions, and policies have been created.';
END $$;
