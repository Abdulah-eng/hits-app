...
import { Code, Mail, Lock, AlertCircle, CheckCircle, ArrowRight } from 'lucide-react'
          ...
          <CardContent>
            ...
            <div className="space-y-4">
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 text-lg border-2 hover:bg-[var(--primary)]/10 hover:border-[var(--primary)] transition-all"
