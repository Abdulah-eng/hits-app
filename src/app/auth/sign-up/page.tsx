...
import { Code, User, Briefcase, AlertCircle, CheckCircle, ArrowRight } from 'lucide-react'
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[var(--background)] flex items-center justify-center p-4">
      <div className={`w-full max-w-2xl transition-all duration-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        {/* Header */}
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center justify-center space-x-2 mb-6 group">
            <div className="w-12 h-12 bg-[var(--primary)] rounded-lg flex items-center justify-center transition-transform group-hover:scale-105">
        ...
        <Card className="border border-[var(--border)] shadow-lg">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full h-12 text-lg bg-[var(--primary)] hover:bg-[var(--primary)]/90"
                disabled={loading}
              >
